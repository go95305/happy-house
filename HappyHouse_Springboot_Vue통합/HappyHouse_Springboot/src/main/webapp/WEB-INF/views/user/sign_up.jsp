...
<div id="wrapper">
	<div id="wrapper-bgbtm" style="width: 700px; margin: 0 auto;">
		...
		<form role="form" method="post" action="${root}/member/signup">
			<div class="form-group" id="divId">
				<label for="inputId" class="col-lg-2 control-label">아이디</label>
				<div class="col-lg-10">
					<input type="text" class="form-control onlyAlphabetAndNumber"
						id="id" data-rule-required="true" name="id" placeholder="아이디"
						maxlength="30">
				</div>
			</div>
			...
			<div class="form-group" id="divName">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control onlyHangul" id="name"
						data-rule-required="true" name="name" placeholder="한글만 입력 가능합니다."
						maxlength="15">
				</div>
			</div>
			...
			<div class="form-group" id="divNickname">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" id="nickname"
						data-rule-required="true" placeholder="별명" name="nickName"
						maxlength="15">
				</div>
			</div>
			...
			<div class="form-group" id="divEmail">
				...
				<div class="col-lg-10">
					<input type="email" class="form-control" id="email"
						data-rule-required="true" placeholder="이메일" name="email"
						maxlength="40">
				</div>
			</div>
			<div class="form-group" id="divPhoneNumber">
				...
				<div class="col-lg-10">
					<input type="tel" class="form-control onlyNumber" id="phoneNumber"
						data-rule-required="true" name="phoneNumber"
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<label class="radio-inline"> <input type="radio"
						id="emailReceiveYn" name="emailCheck" value="Y" checked>
						동의합니다.
					</label> <label class="radio-inline"> <input type="radio"
						id="emailReceiveYn" name="emailCheck" value="N"> 동의하지
						않습니다.
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-10">
					<label class="radio-inline"> <input type="radio"
						id="smsReceiveYn" name="phoneCheck" value="Y" checked>
						동의합니다.
					</label> <label class="radio-inline"> <input type="radio"
						id="smsReceiveYn" name="phoneCheck" value="N"> 동의하지 않습니다.
					</label>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
					<button type="button" id="signin" class="btn btn-primary">Sign
						in</button>
				</div>
			</div>
		</form>
